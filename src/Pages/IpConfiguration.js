...
function IpConfiguration() {
  const [state, setState] = React.useState({
    columns: [
      { title: 'Ip Address', field: 'address', initialEditValue: '' },
      {
        title: 'Status',
        field: 'status',
      ...
      <MaterialTable
        ...
        editable={{
          onRowAdd: (newData) =>new Promise((resolve)=>{
            let {address,status}=newData
            IpService.addNewIP({address,status})
            .then(res=>{
          ...
          onRowUpdate: (newData, oldData) =>
            ...
            new Promise((resolve) => {
              let {_id,address,status}=newData
              IpService.editIp(_id,{address,status})
              .then(res=>{
                setState((prevState) => {
