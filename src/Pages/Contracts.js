...
function Contracts() {
  const [state, setState] = React.useState({
    columns: [
      { title: 'Contract Name', field: 'name', initialEditValue: '' },
      {
        title: 'Status',
        field: 'status',
      ...
      <MaterialTable
        ...
        editable={{
          onRowAdd: (newData) =>new Promise((resolve)=>{
            ...
            ContractService.createContract(newData)
            .then(res=>{
          ...
          onRowUpdate: (newData, oldData) =>
            ...
            new Promise((resolve) => {
              let {_id,name,status,sickLeave,casualLeave,annualLeave}=newData
              ContractService.EditContract(_id,{name,status,sickLeave,annualLeave,casualLeave})
              .then(res=>{
                setState((prevState) => {
